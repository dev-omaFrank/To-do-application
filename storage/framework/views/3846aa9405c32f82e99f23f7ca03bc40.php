                ...
                <div class="row">
                    <div class="showcase-box col-md-4">
                        <div class="showcase-item">
                            <img src="<?php echo e(asset('img/icon1.webp')); ?>" style="height: 80%;" alt="">
                    ...
                    <div class="showcase-box col-md-4">
                        <div class="showcase-item">
                            <img src="<?php echo e(asset('img/icon2.png')); ?>" style="height: 80%;" alt="">
                            <p>Organizing your activities while learning</p>
                        </div>
                    </div>
                    <div class="showcase-box col-md-4">
                        <div class="showcase-item">
                            <img src="<?php echo e(asset('img/icon3.jpg')); ?>" style="height: 80%;" alt="">
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Laravel\laravelLearning\resources\views/home.blade.php ENDPATH**/ ?>